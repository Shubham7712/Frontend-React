  ...
  const GetAll = () => {
    api.get('/Admin/User/find/' + UserId).then((res) => {
      if (res.data.status === true) {
        ...
        setImage(`http://localhost:5000/${newData.Image}`);
      }
      // console.log('setting by id monday------', res.data.PageSetup.Monday.StartTime);

      console.log('imageeeeeeeeeeeeeeee', Image);
    });
  };
    ...
    try {
      api.post('Admin/User/update/' + UserId, postData).then((res) => {
        ...
        if (res.data.status == true) {
          ...
          toast.error('User profile not updated !' || 'Failed');
    ...
    <>
      ...
      <section className="breadcrumb" style={{marginTop: '100px'}}>
        <div className="container">
          <div className="row">
            <h2 className="col-md-6 col-12 section-title">My Profile</h2>
          </div>
        </div>
      </section>
                      ...
                      <div className="contact-form">
                        <form onSubmit={handleSubmit(onSubmit)}>
                          ...
                          <div className="row">
                            ...
                            <div className="col-6 form-group">
                              <Label className="form-div mr-2" for="Image *">
                                Profile Image *
                              </Label>
                              <div className="mb-2">
                                <Input
